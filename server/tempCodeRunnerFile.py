...
PRESETS = {
    "music": {
        "sliders": [
            {"label": "Guitar", "windows": [{"startHz": 40, "widthHz": 360}]},
            {"label": "Flute", "windows": [{"startHz": 400, "widthHz": 400}]},
            {"label": "Violin", "windows": [{"startHz": 950, "widthHz": 3050}]},
            {"label": "Xylophone", "windows": [{"startHz": 5000, "widthHz": 9000}]}
        ]
    },
    "animals": {
        "sliders": [
            {"label": "Dog", "windows": [{"startHz": 0, "widthHz": 450}]},
            {"label": "Wolf", "windows": [{"startHz": 450, "widthHz": 650}]},  # 450+650=1100
            {"label": "Crow", "windows": [{"startHz": 1100, "widthHz": 1900}]},  # 1100+1900=3000
            {"label": "Bat", "windows": [{"startHz": 3000, "widthHz": 6000}]}  # 3000+6000=9000
        ]
    },
    "voices": {
        "sliders": [
